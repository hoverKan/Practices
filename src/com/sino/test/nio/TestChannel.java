...
/**
 * @author Hover Kan
 * @create 2018-11-17 上午10:59
 * <p>
 * 一、通道(Channel): 用于源节点与目标节点的连接。在Java NIO 中负责缓冲区中数据的传输。
 * Channel 本身不存储数据，因此需要配合缓冲区进行缓冲
 * <p>
 * 二、通道的主要实现类
 ...
 * <p>
 * 三、获取通道
 * 1、Java 针对支持通道的类提供了 getChannnel() 方法
 * 本地 IO：
...
public class TestChannel {
    ...
    public void test4() throws Exception {
        ...
        //2、分配指定大小的缓冲区
        ByteBuffer buf1 = ByteBuffer.allocate(120);
        ByteBuffer buf2 = ByteBuffer.allocate(120);
    ...
    public void test3() throws IOException {
        FileChannel inChannel = FileChannel.open(Paths.get("IMG_0001.jpg"), StandardOpenOption.READ);
        FileChannel outChannel = FileChannel.open(Paths.get("Hover.jpg"), StandardOpenOption.WRITE,StandardOpenOption.READ, StandardOpenOption.CREATE);
    ...
    public void test1() {
        ...
        try {
            fis = new FileInputStream("IMG_0001.jpg");
            fos = new FileOutputStream("HoverKan.jpg");
